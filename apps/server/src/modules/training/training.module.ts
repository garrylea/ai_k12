...
import { MainErrorBooksRepository, QuestionsRepository, QuestionHintsRepository } from '../../database/repositories/index.js';
import { HintCapability } from '../../ai-core/capabilities/hint.capability.js';

/**
 * 错题训练模块（Task 1 骨架 + Task 2 判题 + Task 3 提示缓存）。
 *
...
@Module({
  ...
  providers: [TrainingService, MainErrorBooksRepository, QuestionsRepository, QuestionHintsRepository, HintCapability],
})
