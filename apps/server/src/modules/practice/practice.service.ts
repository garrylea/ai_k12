...
// 此处 re-export 维持既有导入路径（controller 等外部消费方不变）。
export type { JudgeInput, JudgeOutput } from './judge-core.service.js';
import type { JudgeInput, JudgeOutput } from './judge-core.service.js';
