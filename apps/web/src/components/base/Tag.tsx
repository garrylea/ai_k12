...
type TagVariant = 'knowledge' | 'easy' | 'medium' | 'hard' | 'mainline' | 'auxiliary' | 'training' | 'neutral' | 'source';
...
const variantStyles: Record<TagVariant, string> = {
  ...
  // 三轨共用同一套色，靠**文字**区分轨道（style.md：轨道不用颜色编码，避免与主线/辅线色混淆）
  mainline: 'bg-[var(--brand-100)] text-[var(--brand-600)]',
  auxiliary: 'bg-[var(--brand-100)] text-[var(--brand-600)]',
  training: 'bg-[var(--brand-100)] text-[var(--brand-600)]',
