...
> **【2026-09-08 修订注记】** 本设计中「辅线错题本」相关内容（P4.1 辅线 Tab、/api/error-book/aux 端点、侧栏辅线错题本入口）已被 PRD §7.4 修订取代——全系统唯一主线错题本，辅线答疑题目入 main_error_books（source=auxiliary，不参与清零门禁）。
